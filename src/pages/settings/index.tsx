						...
						<Card className='border border-gray-200'>
							<CardContent className='p-4'>
								<div className='flex flex-col items-center text-center'>
									...
									<p className='mb-4 text-gray-500 text-sm'>Encontre respostas para dúvidas comuns</p>
						...
						<Card className='border border-gray-200'>
							<CardContent className='p-4'>
								<div className='flex flex-col items-center text-center'>
									...
									<p className='mb-4 text-gray-500 text-sm'>Fale diretamente com nossa equipe de suporte</p>
									<Button onClick={handleWhatsAppSupport} variant='ghost' className='w-full'>
