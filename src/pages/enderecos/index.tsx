		...
		return (
			<div className='flex flex-col items-center justify-center px-4 py-8'>
				<div className='mb-6 text-center'>
					<h1 className='font-bold text-2xl'>Entre para acessar seus endereços</h1>
					<p className='mx-auto mt-2 max-w-md text-gray-600'>Faça login para visualizar e gerenciar seus endereços</p>
				</div>
			</div>
		)
	}
	...
	return (
		<div className='mx-auto w-full max-w-[900px] px-2 md:px-0'>
			<div className='mb-5 text-center md:text-left'>
				...
				<p className='text-gray-600 text-sm md:text-base'>Gerencie seus endereços</p>
			</div>
			...
			<div className='rounded-lg bg-white p-4 shadow-xs md:p-6'>
				...
				<div className='border-gray-100 border-t pt-4'>
					...
					<p className='text-gray-500 text-sm'>
						Os endereços são usados apenas para fins de faturamento associados aos métodos de pagamento. Não enviamos
						correspondência física para estes endereços.
					</p>
				</div>
			</div>
		</div>
