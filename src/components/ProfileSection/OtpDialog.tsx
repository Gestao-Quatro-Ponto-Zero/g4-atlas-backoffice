	...
	return (
		<Dialog open={isOpen} onOpenChange={onOpenChange}>
			<DialogContent className='md:max-w-md'>
				...
				<DialogHeader>
					<DialogTitle className='text-center font-semibold text-2xl'>Confirmar {verifyingField}</DialogTitle>
				</DialogHeader>
				<div className='flex flex-col space-y-6 py-4'>
					<p className='text-center text-gray-700'>Digite o código enviado para {contactValue}</p>
					...
					<Button variant='ghost' onClick={onSwitchMethod} className='text-blue-600 text-sm hover:text-blue-800'>
