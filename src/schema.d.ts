...
export interface components {
	schemas: {
		...
		Order: {
			...
			net_value?: number;
			discount?: string;
			tax_retention?: string;
			type?: string;
			addendum_type?: string;
			addendum_order_id?: string;
			utms?: components["schemas"]["Utms"];
			accession_policy_accepted?: boolean;
			payments?: components["schemas"]["Payment"][];
			sales_executive?: components["schemas"]["SalesExecutive"];
		...
		OrderProduct: {
			code?: string;
			value?: string;
			product_details?: components["schemas"]["ProductDetails"];
			business_unit?: components["schemas"]["BusinessUnit"];
			company?: components["schemas"]["ProductCompany"];
			discount?: string;
			net_price?: string;
			/** Format: int32 */
			quantity?: number;
		...
		Payment: {
			...
			/** Format: int32 */
			cycle?: number;
			company?: components["schemas"]["PaymentCompany"];
		};
		PaymentCompany: {
			name?: string;
			code?: string;
...
export interface operations {
	...
	sotSalesEvent: {
		...
		requestBody: {
			content: {
				"application/json": components["schemas"]["SalesEvent"];
			};
		};
		responses: {
			/** @description OK */
