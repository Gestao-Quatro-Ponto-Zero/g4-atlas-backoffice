...
export const PaymentMethodCard = ({
	...
	const [associatedAddress, setAssociatedAddress] = useState<Address | null>(null);
					...
					<div className="flex space-x-1">
						...
						>
							...
							<DialogContent className="md:max-w-md">
								...
								<Form {...form}>
									<form
										onSubmit={form.handleSubmit(handleSubmitEditCard)}
										className="space-y-4"
									>
						...
						>
							...
							<AlertDialogContent>
								<AlertDialogHeader>
									...
									<AlertDialogDescription>
										Tem certeza que deseja excluir este cartão? Esta ação não
										pode ser desfeita.
									</AlertDialogDescription>
								</AlertDialogHeader>
								<AlertDialogFooter>
