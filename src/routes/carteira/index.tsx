...
export const Route = createFileRoute("/_layout/carteira")({
	component: () => {
		...
		return (
			<div
				className="mx-auto w-full px-2 md:px-0"
				...
				<div className="rounded-lg bg-white p-4 shadow-xs md:p-6">
					...
					<div className="border-gray-100 border-t pt-4">
						...
						<p className="text-gray-500 text-sm">
							Os cartões adicionados aqui estarão disponíveis para uso em suas
							próximas compras. Suas informações de pagamento são armazenadas
							com segurança e criptografadas. Boletos e PIX são gerados no
