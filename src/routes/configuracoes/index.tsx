					...
					<CardContent className="space-y-4">
						<div className="space-y-2">
							...
							<p className="text-gray-500 text-sm">
								Esta chave será usada no header de todas as requisições para a API de contas.
							</p>
						</div>
						...
						<div className="rounded-lg bg-blue-50 p-4">
							...
							<p className="mt-1 text-blue-700 text-sm">
								A API key é armazenada localmente no seu navegador e será incluída 
								automaticamente no header "ACCOUNTS-API-KEY" de todas as requisições.
							</p>
						</div>
					</CardContent>
				</Card>
